 ...
 * 
 * Display fabric assigned to event.
 */
...
const mockFabric = {
  ...
  is_primary: true,
  description: 'High-quality traditional fabric, perfect for ASO-EBI occasions.',
};
  ...
  return (
    <ScrollView style={{ flex: 1, backgroundColor: colors.neutral[50] }}>
      ...
      <View style={{ padding: spacing.lg }}>
        ...
        >
          ...
          <View style={{ marginBottom: spacing.lg }}>
            ...
            <Text style={{ fontSize: 16, lineHeight: 24, color: colors.neutral[600] }}>
              {fabric.description || 'High-quality traditional fabric, perfect for ASO-EBI occasions. Durable and vibrant colors that last.'}
            </Text>
          </View>
        ...
        {/* Continue Button */}
        <Button
          title="Continue to Tailor Selection"
