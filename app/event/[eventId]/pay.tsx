...
/**
 * Guest Payment Flow (U1 - Step 3)
 * 
 * Mandatory escrow-based payment.
 * No tailor work starts without escrow held.
 * 
 * Flow:
 * 1. Show amount to pay (event price or custom)
 * 2. Display escrow guarantee
 * 3. Process payment (initiates escrow)
      ...
      <ScrollView style={{ flex: 1, backgroundColor: colors.neutral[50] }}>
        <View style={{ padding: spacing.lg }}>
          ...
          >
            ...
            >
              <Text style={{ fontSize: 16, lineHeight: 24, color: colors.neutral[600] }}>Event</Text>
            ...
            <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
              <Text style={{ fontSize: 16, lineHeight: 24, color: colors.neutral[600] }}>Amount</Text>
